    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('programmetrimestriel.create') }}"
        ...
        <div class="mt-8 bg-white rounded border-b-4 border-gray-300">
            ...
            @foreach ($programmetrimestriel as $programmetrimestriel)
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    <div
                        class="w-2/12 px-3 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $programmetrimestriel->title }}</div>
                    <div
                        class="w-2/12 px-3 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $programmetrimestriel->nom }}</div>
                    <div
                        class="w-2/12 px-3 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $programmetrimestriel->rate }}</div>
                    <div
                        class="w-2/12 px-3 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $programmetrimestriel->description }}</div>
                    <div class="w-2/12 flex items-center justify-end px-3">
                        <a href="{{ route('programmetrimestriel.show',$programmetrimestriel->id) }}"
                        ...
                        <a href="{{ route('programmetrimestriel.edit',$programmetrimestriel->id) }}" class="ml-1">
                        ...
                        <a href="{{ route('programmetrimestriel.destroy', $programmetrimestriel->id) }}"
                           data-url="{!! URL::route('programmetrimestriel.destroy', $programmetrimestriel->id) !!}"
